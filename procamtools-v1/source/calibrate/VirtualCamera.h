...
public:
	...
	static VirtualCamera* NewCamera(unsigned int interfaceNum, unsigned int camNum, CameraTriggerMode triggerMode);
	// Interface function
	VirtualCamera(CameraTriggerMode _triggerMode) : capturing(false), triggerMode(_triggerMode){}
